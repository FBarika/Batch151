...
public enum UsStatesEnum {
    /*
    Enumlar degisme ihtimali olmayan datalari depolamak icin kullanilir; mesela gün isimleri,eyalet iismleri...
    Mesela app imizde gün isimlerini kullanacaksak gün isimlerini enuma depolariz cünkü app kendi basina ayakta durabilmelidir (buna stand alone denir )
    Mesela app e google git gün isimlerini bul eyelat isimlerini bul diyemeyiz cok basit data olsa bile ihtiyacimiz varsa enum icine koyariz.
    ...
    */
    ...
    //Enum icine kac tane detay koyduysak o kadar variable olusturmaliyiz.
    ...
    //static yapiyoruz cünkü enum in ismiyle methoda ulasmak istiyorum yoksa obje olusturmak zorunda kaliriz.
    ...
    public static String getStateNameByUsingAbbreviation(String abbreviation){
        return Arrays.stream(values())
                ...
                .findFirst().get().getStateName();// bu kod lambda ögrenecegiz!!!!!
    }
