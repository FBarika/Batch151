...
public class IllegalGradeException extends Exception {//Eger kendi olusturdugumuz exception in CTE olmasini istiyorsak Exception in child i yapmaliyiz.
                                                    //Benim Exception class in exception class in bütün özelliklerini kullanabilsin diye.
    /*

     1)Custom Exception Class(kendi olusturdugumuz)  olusturmak icin "Exception Class a"(exception nin child i) extend etmeliyiz.
     Exception Class a extend ederek olusturdugumuz costum exception "Compile Time Exception" olur.
     2)Custom Exception Class olustururken constructor olusturmalisiniz
     Bu constructor parenttaki costructor i cagirmalidir.(super() yazarak cagiririz)
    ...
    public IllegalGradeException () {//ben olusturulan objenin Exception class indan olusturulmasini istedigim icin super(); yaziyoruz.
        super();
    }
}
