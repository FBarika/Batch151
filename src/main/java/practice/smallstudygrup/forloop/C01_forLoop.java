...
public class C01_forLoop {
    public static void main(String[] args) {
        ...
        int kullaniciSayi=0;
        do {
            System.out.println("lutfen tahminde bulunmak icin -3 ile 7 arasinda tamsayi giriniz");
            kullaniciSayi= scan.nextInt();
            if (kullaniciSayi<sayi1){
                System.out.println("lutfen daha buyuk bir sayi giriniz");
            } else if (kullaniciSayi>sayi1) {
                System.out.println("lutfen daha kucuk bir sayi giriniz");
            }
            counter++;
        }while (sayi1!=kullaniciSayi);
