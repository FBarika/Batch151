...
public class C01_StaticKeyword {
    ...
    static int sayi1;//static ve ibstance lara herhangi bir deger atamak zorunda degiliz.
    int sayi2;

    public static void main(String[] args) {
        C01_StaticKeyword obj1 = new C01_StaticKeyword();
        C01_StaticKeyword obj2 = new C01_StaticKeyword();
        //sayi1++; static variable lari kullanamak icin obje olusturmya gerek yoktur.
